-- ========================================
-- FIX: Doc Receive Notification System
-- ========================================
-- Changes:
-- 1. Disable INSERT trigger for doc_receive (no notification when created)
-- 2. Notify ALL clerks when doc_receive is rejected
-- 3. Notify ALL clerks when doc_receive is completed
-- 4. Keep memos behavior unchanged (notify only 1 clerk)

-- =====================================================
-- STEP 1: Drop INSERT trigger for doc_receive
-- =====================================================
DROP TRIGGER IF EXISTS telegram_notify_on_doc_receive_created ON doc_receive;

-- =====================================================
-- STEP 2: Update trigger function to notify all clerks for doc_receive
-- =====================================================
...
-- =====================================================
-- STEP 3: Verify remaining triggers
-- =====================================================
SELECT
  trigger_name,
  event_manipulation,
...
SELECT 'Doc Receive notification system has been fixed!' as status;
