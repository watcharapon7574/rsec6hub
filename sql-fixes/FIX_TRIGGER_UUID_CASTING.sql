-- ========================================
-- FIX: Add UUID type casting to trigger functions
-- ========================================
...
BEGIN
  ...
  -- Get author's telegram_chat_id from PROFILES table (FIX: Cast user_id to text)
  BEGIN
...
ALTER TABLE memos ENABLE TRIGGER telegram_notify_on_memo_created;
ALTER TABLE doc_receive ENABLE TRIGGER telegram_notify_on_doc_receive_status_change;
ALTER TABLE doc_receive ENABLE TRIGGER telegram_notify_on_doc_receive_created;

-- Re-enable RLS
ALTER TABLE memos ENABLE ROW LEVEL SECURITY;
ALTER TABLE doc_receive ENABLE ROW LEVEL SECURITY;

SELECT 'All trigger functions have been fixed with proper UUID casting!' as status;
