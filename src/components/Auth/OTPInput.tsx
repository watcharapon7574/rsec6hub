      ...
      <div className="flex justify-center gap-2">
        {otp.map((data, index) => (
          <input
            ...
            className="w-12 h-12 text-center text-lg font-semibold border-2 border-blue-200 rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 focus:outline-none transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
          />
        ))}
      </div>
