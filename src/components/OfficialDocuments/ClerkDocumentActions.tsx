    ...
    return (
      <div className="relative">
        <Button
          ...
          className="bg-green-50 dark:bg-green-950 border-green-500 text-foreground hover:bg-green-100 dark:bg-green-900 dark:hover:bg-green-900"
        >
      ...
      <DialogContent className="max-w-6xl max-h-[90vh] overflow-y-auto">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          ...
          <TabsContent value="reject" className="space-y-4">
            <Card>
              <CardHeader>
                <CardTitle className="text-red-600 dark:text-red-400 dark:text-red-600">ตีกลับเอกสาร</CardTitle>
              </CardHeader>
          ...
          <TabsContent value="number" className="space-y-4">
            <Card>
              <CardHeader>
                <CardTitle className="text-blue-600 dark:text-blue-400 dark:text-blue-600">ลงเลขหนังสือราชการ</CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                <div>
          ...
          <TabsContent value="signers" className="space-y-4">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
              <Card>
                <CardHeader>
                  <CardTitle className="text-green-600 dark:text-green-400 dark:text-green-600">เลือกผู้ลงนาม</CardTitle>
                </CardHeader>
                <CardContent>
              ...
              <Card>
                <CardHeader>
                  <CardTitle className="text-purple-600 dark:text-purple-400 dark:text-purple-600">ผู้ลงนามที่เลือก</CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="space-y-2">
                        ...
                        {selectedSigners.map((signer, index) => {
                          ...
                          return (
                            <div key={signer.user_id} className="p-3 border rounded-lg">
                              ...
                              {position ? (
                                <p className="text-xs text-green-600 dark:text-green-400 dark:text-green-600">✓ กำหนดตำแหน่งแล้ว</p>
                              ) : (
