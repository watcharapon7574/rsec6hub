      ...
      <CardContent className="p-6">
        <div className="grid grid-cols-2 gap-4">
          ...
          <Button 
            ...
            className="flex flex-col h-20 gap-2 hover:bg-blue-50 dark:hover:bg-blue-950 dark:bg-blue-950 hover:border-blue-300 dark:border-blue-700"
          >
            <Calendar className="h-5 w-5 text-blue-600 dark:text-blue-400 dark:text-blue-600" />
          ...
          <Button 
            ...
            className="flex flex-col h-20 gap-2 hover:bg-blue-50 dark:hover:bg-blue-950 dark:bg-blue-950 hover:border-blue-300 dark:border-blue-700"
          >
            <Printer className="h-5 w-5 text-blue-600 dark:text-blue-400 dark:text-blue-600" />
          ...
          <Button 
            ...
            className="flex flex-col h-20 gap-2 hover:bg-blue-50 dark:hover:bg-blue-950 dark:bg-blue-950 hover:border-blue-300 dark:border-blue-700"
          >
            <Phone className="h-5 w-5 text-blue-600 dark:text-blue-400 dark:text-blue-600" />
          ...
          <Button 
            ...
            className="flex flex-col h-20 gap-2 hover:bg-blue-50 dark:hover:bg-blue-950 dark:bg-blue-950 hover:border-blue-300 dark:border-blue-700"
          >
            <Mail className="h-5 w-5 text-blue-600 dark:text-blue-400 dark:text-blue-600" />
          ...
          <Button 
            ...
            className="flex flex-col h-20 gap-2 hover:bg-blue-50 dark:hover:bg-blue-950 dark:bg-blue-950 hover:border-blue-300 dark:border-blue-700"
          >
            <Calculator className="h-5 w-5 text-blue-600 dark:text-blue-400 dark:text-blue-600" />
