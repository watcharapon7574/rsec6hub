        ...
        <div className="space-y-4">
                ...
                {approvers.assistant.selectedName && (
                  <div className="p-4 bg-blue-50 dark:bg-blue-950 rounded-lg border border-blue-200 dark:border-blue-800">
                    <div className="space-y-2">
                      ...
                      <p className="text-sm text-blue-600 dark:text-blue-400 dark:text-blue-600">{approvers.assistant.selectedPosition}</p>
              ...
              <div className="ml-6 space-y-2">
                ...
                {approvers.deputy.selectedName && (
                  <div className="p-3 bg-blue-50 dark:bg-blue-950 rounded-lg">
                    ...
                    <p className="text-sm text-blue-600 dark:text-blue-400 dark:text-blue-600">{approvers.deputy.selectedPosition}</p>
                  </div>
                )}
              </div>
            )}
          ...
          <div className="space-y-2 p-4 border border-red-200 dark:border-red-800 rounded-lg bg-red-50 dark:bg-red-950">
            ...
            <div className="p-3 bg-card rounded-lg border border-red-200 dark:border-red-800">
              ...
              <p className="text-sm text-red-600 dark:text-red-400 dark:text-red-600">{approvers.director.selectedPosition}</p>
            </div>
          </div>
        </div>
