          ...
          <React.Fragment key={sectionIndex}>
            ...
            {section.items.map((item, itemIndex) => (
              <DropdownMenuItem
                ...
                className="cursor-pointer flex flex-col items-start py-3 px-3 hover:bg-blue-50 dark:hover:bg-blue-950 dark:bg-blue-950 focus:bg-blue-50 dark:bg-blue-950 bg-card"
              >
