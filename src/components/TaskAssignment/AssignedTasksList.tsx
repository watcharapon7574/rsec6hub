...
const AssignedTasksList = () => {
  ...
  const getStatusConfig = (status: TaskStatus) => {
    const configs = {
      pending: {
        label: 'รอดำเนินการ',
        color: 'bg-yellow-100 dark:bg-yellow-900 text-yellow-700 dark:text-yellow-300 border-yellow-200 dark:border-yellow-800',
        icon: Clock,
      },
      in_progress: {
              ...
              <CardContent className="p-6">
                <div className="space-y-4">
                  ...
                  <div className="space-y-2 text-sm">
                    ...
                    {task.completed_at && (
                      <div className="flex items-center text-green-600 dark:text-green-400 dark:text-green-600">
              ...
              <div>
                ...
                {reportFile ? (
                  <div className="flex items-center gap-2 p-3 border-2 border-green-200 dark:border-green-800 bg-green-50 dark:bg-green-950 rounded-lg">
                    <FileText className="h-5 w-5 text-green-600 dark:text-green-400 dark:text-green-600 flex-shrink-0" />
                    <span className="text-sm text-green-700 dark:text-green-300 flex-1 truncate">
                      {reportFile.name}
                    </span>
                    <span className="text-xs text-green-600 dark:text-green-400 dark:text-green-600">
                    ...
                    <Button
                      ...
                      className="h-6 w-6 p-0 hover:bg-red-100 dark:bg-red-900 dark:hover:bg-red-900"
                    >
                      <X className="h-4 w-4 text-red-600 dark:text-red-400 dark:text-red-600" />
                    </Button>
                  </div>
                ) : (
                  <div>
                    ...
                    <label
                      htmlFor="report-file"
                      className="flex items-center justify-center gap-2 p-4 border-2 border-dashed border-border rounded-lg cursor-pointer hover:border-green-400 hover:bg-green-50 dark:hover:bg-green-950 dark:bg-green-950 transition-colors"
                    >
