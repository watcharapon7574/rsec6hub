    ...
    >
      <defs>
        <linearGradient id="fdl-gs" x1="0" y1="0" x2="52" y2="0" gradientUnits="userSpaceOnUse">
          ...
          <stop offset="1" stopColor="#3478F6" stopOpacity="0.45" />
        </linearGradient>
      </defs>
      <g transform="skewX(-4)">
        {/* Document outline */}
        <path
          ...
          className="opacity-[0.55] dark:opacity-80"
        />
        <path
        ...
        <path
          ...
          strokeLinecap="round"
          strokeLinejoin="round"
          className="opacity-25 dark:opacity-[0.4]"
        />
      ...
      />
      {/* Speed trails */}
      <line x1="16" y1="64" x2="42" y2="64" stroke="url(#fdl-gs)" strokeWidth="5" strokeLinecap="round" />
      <line x1="8" y1="84" x2="42" y2="84" stroke="url(#fdl-gs)" strokeWidth="5" strokeLinecap="round" />
      <line x1="20" y1="104" x2="42" y2="104" stroke="url(#fdl-gs)" strokeWidth="5" strokeLinecap="round" />
    </svg>
  );
}
