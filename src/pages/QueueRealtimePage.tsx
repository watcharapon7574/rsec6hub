    ...
    <div className="container mx-auto p-6 max-w-6xl">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
        ...
        <Card>
          ...
          <CardContent>
            <div className="flex items-baseline gap-2">
              <span className="text-3xl font-bold text-green-600 dark:text-green-400 dark:text-green-600">{completedCount}</span>
        ...
        <Card>
          ...
          <CardContent>
            <div className="flex items-baseline gap-2">
              <span className="text-3xl font-bold text-red-600 dark:text-red-400 dark:text-red-600">{failedCount}</span>
      ...
      <Card className="mt-6 bg-muted">
        ...
        <CardContent className="space-y-2 text-sm">
          ...
          <div className="flex justify-between">
            ...
            <span className="font-medium text-green-600 dark:text-green-400 dark:text-green-600">{8 - activeCount}</span>
          </div>
          <div className="flex justify-between">
