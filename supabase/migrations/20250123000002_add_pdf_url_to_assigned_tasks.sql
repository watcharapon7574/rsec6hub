-- Add PDF URL to get_user_assigned_tasks function
-- This allows AssignedDocumentsList to display PDF preview correctly
...
COMMENT ON FUNCTION get_user_assigned_tasks(UUID, VARCHAR, INT, INT) IS 'ดึงรายการงานที่ได้รับมอบหมายของผู้ใช้ - รวม PDF URL';
