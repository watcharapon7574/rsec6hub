-- Fix PDF URL for doc_receive in get_user_assigned_tasks function
-- doc_receive uses pdf_draft_path and pdf_final_path, not pdf_url
...
COMMENT ON FUNCTION get_user_assigned_tasks(UUID, VARCHAR, INT, INT) IS 'ดึงรายการงานที่ได้รับมอบหมายของผู้ใช้ - รวม PDF URL (แก้ไข: ใช้ pdf_draft_path สำหรับ doc_receive)';
