-- Add team management fields to get_user_assigned_tasks function
-- Fields: is_reporter, is_team_leader, assignment_source, position_name, group_name, parent_assignment_id
...
COMMENT ON FUNCTION get_user_assigned_tasks(UUID, VARCHAR, INT, INT) IS 'ดึงรายการงานที่ได้รับมอบหมายของผู้ใช้ - รวม PDF URL, task details, และข้อมูล team management (is_reporter, is_team_leader, assignment_source)';
