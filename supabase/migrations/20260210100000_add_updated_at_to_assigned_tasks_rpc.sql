-- Add updated_at field to get_user_assigned_tasks function
-- เพิ่ม updated_at เพื่อให้สามารถเรียงลำดับตามการกระทำล่าสุดได้
...
COMMENT ON FUNCTION get_user_assigned_tasks(UUID, VARCHAR, INT, INT) IS 'ดึงรายการงานที่ได้รับมอบหมายของผู้ใช้ - รวม updated_at สำหรับเรียงตามการกระทำล่าสุด';
